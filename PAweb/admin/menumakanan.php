          ...
          <tbody>
            <?php $i = 1; foreach($menu_makanan as $makanan) : ?>
              <tr class="table_menu_row">
                ...
                <img src="../uploads/<?php echo $makanan['gambar']; ?>" 
                  alt="<?php echo $makanan['nama']; ?>" 
                  width="80px" height="100px" style="display: block;">
                </td>
                <td class="table_menu_data"><?php echo $makanan['nama'] ?></td>
                <td class="table_menu_data"><?php echo $makanan['harga'] ?></td>
                <td class="table-mahasiswa-data">
                  <div class="button-UD">
                    <a href="editmakanan.php?id=<?php echo $makanan['id']?>">
                      <button class="edit-data">
                        <i class="fa-solid fa-pen" style="color: ffff00;"></i>
                      </button>
                    </a>
                    <a href="hapusmakanan.php?id=<?php echo $makanan['id']?>" onclick="return confirm('Yakin ingin menghapus data ini?');">
                      <button class="hapus-data">
                        <i class="fa-solid fa-trash-can" style="color: ffff00;"></i>
                      </button>
                    </a>
                  </div>
                </td>
